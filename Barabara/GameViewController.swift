...
class GameViewController: UIViewController {
    ...
    func start() {
        ...
        //タイマーを動かす
        timer = Timer.scheduledTimer(timeInterval: 0.005, target: self, selector: #selector(self.up),
    ...
    @IBAction func stop () {
        ...
        let highScorel: Int = saveData.integer(forKey: "scorel" )
        ...
        if score > highScorel {
            ...
            saveData.set(highScorel, forKey: "score2")
